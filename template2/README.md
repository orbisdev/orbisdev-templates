# template2
Basic sample for orbisdev environment using initOrbisLinkVanillaGl
...
[ORBIS][DEBUG]: [ORBISLINK] initOrbisLinkAppVanillaGl sceSysmoduleLoadModuleInternal(SCE_SYSMODULE_INTERNAL_PAD) return: 0x00000000
...
[ORBIS][DEBUG]: [ORBISPAD] orbisPadInit scePadOpen return handle 0x 3030500
[ORBIS][DEBUG]: [ORBISPAD] orbisPadInit liborbispad initialized
[ORBIS][DEBUG]: [ORBISLINK] initOrbisLinkAppVanillaGl liborbisPad initialized
...
[ORBIS][DEBUG]: [ORBISLINK] loadModulesGl piglet modules loaded
